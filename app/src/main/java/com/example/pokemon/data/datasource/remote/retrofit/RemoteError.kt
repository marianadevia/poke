...
data class UnauthorizedError(@SerializedName("error") @Expose val exceptionError: RemoteErrorResponse) : RemoteError()
data class ApiError(@SerializedName("error") val exceptionError: RemoteErrorResponse): RemoteError()
